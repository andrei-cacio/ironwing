...
XHRJson.prototype.ajax = function(method, url, async, data) {
    ...
    if (this.xhr) {
      ...
      this.onDone.call(null, response);
    }
};
...
},{"./utils":45,"lodash/lang/clone":28,"lodash/utility/uniqueId":40,"q":41}],45:[function(require,module,exports){
'use strict';
...
},{"lodash/string/camelCase":36}],46:[function(require,module,exports){
'use strict';
...
},{"./adapters/XHRJson":42,"./core/iw":43}]},{},[46])
